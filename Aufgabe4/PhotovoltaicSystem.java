/**
 * A photovoiltaic system uses sunlight (plus some electricity to operate) to provide electricity
 *
 * @invariant PhotovoltaicSystem uses free forms of energy plus some electricity to run
 * @invariant PhotovoltaicSystem provides electric energy (is-a usable form)
 */
public class PhotovoltaicSystem extends EnergyGenerator implements ElectricPowerUnit, Testable {
    /**
